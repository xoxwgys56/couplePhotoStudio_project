...
public class Display extends JFrame {
	...
	public void render(ImageIcon[] icon, String[] filePath, String[] fileName, int count) {
			...
			class PopupActionClass implements ActionListener {
				...
				public void actionPerformed(ActionEvent e) {
					...
					case "포토샵으로 열기":
						...
						ProcessBuilder photoshop_builder = new ProcessBuilder(photoshopPath,
								photoshop_file.getAbsolutePath());
